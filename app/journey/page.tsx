    ...
    <div className="bg-[var(--page-bg)] min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mt-24 bg-white/50 dark:bg-white/5 rounded-3xl p-8 md:p-12 shadow-sm border border-green/10">
          <h2 className="font-display font-bold text-4xl text-saffron mb-6 text-center">Vijender Pal Singh - A Legacy of Grassroots Service in Sri Karanpur</h2>
          <div className="prose prose-lg dark:prose-invert max-w-none font-sans text-fg/80 space-y-6">
            <p>
              Welcome to the official digital presence of <span className="font-priestacy text-3xl">Vijender Pal Singh</span>, a highly dedicated Bharatiya Janata Party (BJP) Karyakarta whose life and career have been intrinsically linked with the progress and development of <strong>Sri Karanpur</strong> and the broader Rajasthan region. Since beginning his public service journey in 1993, Vijender Pal Singh has established himself as a stalwart of community development, rural infrastructure enhancement, and social justice.
            </p>
            <p>
            ...
            <h3 className="font-display font-bold text-3xl text-green mt-8 mb-4">Championing Infrastructure and Minority Welfare</h3>
            <p>
            ...
            <p className="font-display italic text-xl text-saffron-dark p-6 bg-saffron/10 rounded-xl my-8 border-l-4 border-saffron">
              "True leadership is found not in the corridors of power, but in the dusty lanes of our villages, standing shoulder-to-shoulder with the common man." - <span className="font-priestacy text-3xl not-italic ml-2">Vijender Pal Singh</span>
            </p>
            <p>
            ...
            <h3 className="font-display font-bold text-3xl text-green mt-8 mb-4">Looking Towards the Future of Rajasthan Politics</h3>
            <p>
